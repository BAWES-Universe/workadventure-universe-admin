...
const AlertDialogTitle = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Title> & React.PropsWithChildren
>(({ className, ...props }, ref) => (
...
const AlertDialogDescription = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Description> & React.PropsWithChildren
>(({ className, ...props }, ref) => (
